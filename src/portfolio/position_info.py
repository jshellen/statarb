# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 16:33:47 2019
...
class PositionInfo:
    ...
    Convenience class to keep records of a position.
    
    This class records trades for TCA and position status for PNL-analysis.
